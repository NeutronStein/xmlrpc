...
type UserAgentSwitcher interface {
    SetUserAgent(r *http.Request)
}
type userAgentSwitcher struct {
    userAgent string
}

func (ua *userAgentSwitcher) SetUserAgent(r *http.Request) {
    r.Header.Set("User-Agent", ua.userAgent)
}
func UserAgent(userAgent string) ClientOption {
    return func(codec *clientCodec) {
        codec.userAgentSwitcher = &userAgentSwitcher{
            userAgent: userAgent,
        }
    }
}
...
func (codec *clientCodec) WriteRequest(request *rpc.Request, args interface{}) (err error) {
    ...
    if codec.userAgentSwitcher != nil {
        codec.userAgentSwitcher.SetUserAgent(httpRequest)
    }
    ...
    if codec.debug {
        debug(httputil.DumpRequest(httpRequest, true))
    }
    ...
    if codec.debug {
        debug(httputil.DumpResponse(httpResponse, true))
    }
